...
public class MidFcstInfoServiceRepository {
	...
	*/
	...
	public String requestApi_getMidTa() throws Exception {
        ...
        urlBuilder.append("&" + URLEncoder.encode("tmFc","UTF-8") + "=" + URLEncoder.encode("202607280600", "UTF-8")); /*-일 2회(06:00,18:00)회 생성 되며 발표시각을 입력- YYYYMMDD0600(1800) 최근 24시간 자료만 제공*/
        ...
        //String jsonResultText = sb.toString();
        return sb.toString(); // api 요청으로 통해 응답받은 json 포맷의 텍스트

...
public class Quiz01 {
	...
	public static void main(String[] args) {
		...
		//#퀴즈
				...
				a. $ystem
				b. channel#112 : # 사용할 수 없음
				c. 7eleven : 숫자로 변수명을 시작할 수 없음
				d. newmember : 사용할 수 있으나 다른 단어가 붙을 경우 첫 문자를 대문자로 함 -> newMember
				e. $MAX_NUM
				f. hello@com : @ 사용할 수 없음
				g. int : 자바 예약어는 사용할 수 없음

				//7. 다음중 변수 초기화가 잘못 된 것은?
				a. int b = 255;
				b. String s = "T";
				c. char answer = 'no'; -> char 문자 1개만 가능함.
				d. char flag = 'F';
